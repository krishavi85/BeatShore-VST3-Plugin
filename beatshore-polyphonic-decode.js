...
// vendor/basic-pitch-model/LICENSE-basic-pitch-apache-2.0.txt). This file
// contains only the pure post-processing math (turning the model's raw
// frame/onset/contour tensors into discrete notes) — no ML code of its own.
// The actual pitch/onset/note-frame detection is the pretrained CNN in
// vendor/basic-pitch-model/, run by beatshore-polyphonic-worker.js.
//
// Loaded as a classic (non-module) script via importScripts() so it can sit
// next to tfjs's UMD build in the same worker.
"use strict";
...
(function (global) {
  ...
  function outputToNotesPoly(frames, onsets, onsetThresh, frameThresh, minNoteLen, inferOnsets, maxFreq, minFreq, melodiaTrick, energyTolerance) {
  ...
  global.BeatShorePolyDecode = { outputToNotesPoly, noteFramesToTime, AUDIO_SAMPLE_RATE };
